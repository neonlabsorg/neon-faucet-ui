...
export const TokenSelect = ({ className = "", tokenName = "", onChoose = () => {} }: any) => {
  ...
  return (
    <div className={`flex flex-col relative ${className}`}>
      ...
      flex items-center justify-between ${opened ? "bg-dark-hover-inputs" : null} ${
          tokenName ? "bg-dark-hover-inputs" : null
        }`}
      ...
      {opened === true ? (
        <div className="absolute w-full top-full z-10 mt-2">
          <div
            className={
              "overflow-y-auto absolute w-full bg-dark-600 rounded-b-lg top-full rounded-t-lg z-20"
            }
            style={{
              maxHeight: "240px",
            }}
